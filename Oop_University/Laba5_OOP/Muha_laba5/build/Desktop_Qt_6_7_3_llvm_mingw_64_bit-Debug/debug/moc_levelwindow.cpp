...
struct qt_meta_stringdata_CLASSLevelWindowENDCLASS_t {};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLevelWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LevelWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLevelWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLevelWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLevelWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *LevelWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLevelWindowENDCLASS.stringdata0))
